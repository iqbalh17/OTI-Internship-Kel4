    ...
    <div className="min-h-screen bg-[#FFF7E4] flex justify-center">
      <div className="w-[360px] min-h-screen flex flex-col justify-center items-center px-8 gap-6">
        ...
        <div className="text-center">
          <h1 className={`${poppins.className} text-3xl font-normal text-[#000000] text-shadow-lg`}>
            Selamat Datang di
          </h1>
        ...
        <div className="flex gap-3 mt-[160px]">
          <Link href="/masuk">
            <button className="px-5 py-2 rounded-full border-2 border-[#C04000] text-[#C04000] text-sm">
              Masuk
            </button>
          </Link>
          <Link href="/daftar">
            <button className="px-5 py-2 rounded-full bg-[#C04000] text-white text-sm">
              Daftar Akun
            </button>
          </Link>
        </div>
