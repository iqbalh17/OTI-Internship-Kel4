      ...
      <div className={poppins.className + " w-[360px] min-h-screen flex flex-col justify-end px-9 pb-[146px]"}>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            <label className="text-sm text-[#000000]">No. HP</label>
          ...
          <div className="flex flex-col gap-1">
            <label className="text-sm text-[#000000]">Nama Lengkap</label>
            <div className="flex items-center gap-3 bg-white rounded-2xl px-4 py-3 shadow-xl">
          ...
          <div onClick={() => setShowDropdown(true)} className="flex flex-col gap-1">
            <label className="text-sm text-[#000000]">Asal Banjar</label>
            <div className="flex items-center gap-3 bg-white rounded-2xl px-4 py-3 shadow-xl">
          ...
          <div className="flex flex-col gap-1">
            <label className="text-sm text-[#000000] ">Buat Password</label>
            <div className="flex items-center gap-3 bg-white rounded-2xl px-4 py-3 shadow-xl">
        ...
        <button className="w-full bg-[#C04000] text-white font-bold py-4 rounded-full mt-8 shadow-xl">
          Daftar Akun
        </button>
