  ...
  return (
    <div className="min-h-screen bg-[#FFF7E4] flex justify-center">
      <div className={poppins.className + " w-[360px] min-h-screen flex flex-col pt-16 pb-24 px-5 gap-5"}>
        ...
        <div>
          <p className="text-sm font-bold mb-2">Ceritakan tentang karya ini</p>
          <div className="flex items-end gap-2 bg-white rounded-2xl px-4 py-3 relative">
            ...
            <textarea
              ...
              className="bg-transparent text-sm outline-none w-full text-gray-400 resize-none h-16 pr-10"
              value={cerita}
        ...
        <div>
          <p className="text-sm font-bold mb-2">Siapa yang bisa melihat?</p>
        ...
        <div>
          <p className="text-sm font-bold mb-2">Kategori Kerajinan</p>
          <div className="bg-white rounded-2xl px-4 py-3">
            <select
              className="bg-transparent text-sm outline-none w-full"
              value={kategori}
